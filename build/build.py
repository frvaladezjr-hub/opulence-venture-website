  ...
  <div class="container">
    ...
    <div class="partner-grid reveal">
      ...
      <div class="partner-card">
        ...
        <div class="partner-card-embed">
          <p class="partner-card-embed-label">Try Irongate&rsquo;s FICA Savings Calculator</p>
          <iframe src="https://benefits.igbusinessadvisors.com/benefits/calculator" title="Irongate Business Advisors FICA Savings Calculator" loading="lazy" class="partner-card-iframe"></iframe>
          <p class="partner-card-embed-note">Estimates are provided directly by Irongate Business Advisors and are for illustration only; actual savings depend on the plan selected and individual circumstances.</p>
        </div>
      </div>
    </div>
  </div>
